...
public class ChatRoomUI extends JFrame
{
	...
	private JTextArea inputMessageTextArea = new JTextArea("输入消息");// 消息输入框
	private JScrollPane sp = null; // 聊天记录滚动面板
	private JComboBox<String> onlineListCombo = new JComboBox<>();// 用户列表
	private JButton exitButton = new JButton("退出");// 退出按钮
